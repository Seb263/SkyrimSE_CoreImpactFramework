...
The Core Impact Framework (CIF) is a modular impact system overhaul powered by SKSE, giving full control over effects like impacts, blood, visuals, sounds, and more. It's script-free, highly compatible, and fully customizable via filters and modifiers.

The mod can be downloaded here: [nexusmods.com](https://www.nexusmods.com/skyrimspecialedition/mods/146873)
